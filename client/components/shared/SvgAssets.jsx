...
export const Arrow = (_props) => {
  ...
  return (
    <svg {...props} ref={_props.innerRef} transform={_props.pointUp && 'rotate(180)'} viewBox="0 0 158.49600219726562 219.49998474121094" width={`${(_props.scale || 1) * 158.49600219726562}`} height={`${(_props.scale || 1) * 219.49998474121094 * 1.5}`} xmlns="http://www.w3.org/2000/svg">
